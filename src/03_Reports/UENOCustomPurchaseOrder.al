        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DocDate_PurchHeader; Format("Purchase Header"."Document Date", 10, '<Day,2>/<Month,2>/<Year4>'))
                    {
                    }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(LineDisc_PurchLine; "Purchase Line"."Line Discount %" / 100)
                        {
                        }
                        ...
                        column(TotalAmtInclVAT; "Purchase Line"."Amount Including VAT")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
